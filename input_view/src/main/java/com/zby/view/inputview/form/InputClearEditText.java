 ...
 */
public class InputClearEditText extends AppCompatEditText {
    ...
    public InputClearEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public InputClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.drawable.comm_clear_button);
    }
